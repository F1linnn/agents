...
SC_AGENT_IMPLEMENTATION(Find_all_parameters)
{
  ...
  ms_context->CreateEdge(ScType::EdgeAccessConstPosPerm, answer, Keynodes::nrel_parameters);

  ScIterator5Ptr iterator5_1 = IteratorUtils::getIterator5(ms_context.get(), param, Keynodes::nrel_parameters, true); // find inclusion*
  ...
  while (iterator5_1->Next())
  {
    ...
    ms_context->CreateEdge(ScType::EdgeAccessConstPosPerm, answer, iterator5_1->Get(4)); // nrel_inclusion*Ы
  }
